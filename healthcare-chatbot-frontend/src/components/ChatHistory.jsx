...
const ChatHistory = () => {
    ...
    const fetchChatSessions = async () => {
        try {
            ...
            const response = await axios.get(`${process.env.REACT_APP_CHAT_URL}/api/chat-history/sessions`, {
                headers: { 
    ...
    const fetchSessionDetails = async (sessionId) => {
        try {
            const token = localStorage.getItem('token');
            const response = await axios.get(`${process.env.REACT_APP_CHAT_URL}/api/chat-history/session/${sessionId}`, {
                headers: { 
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
